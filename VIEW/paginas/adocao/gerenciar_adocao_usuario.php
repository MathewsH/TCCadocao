                ...
                <div class="table-wrapper">
                        ...
                        <div class="row">
                            <div class="w3-bar w3-xlarge w3-white w3-opacity w3-hover-opacity-off">
                                <br><center><h2>Gerenciar <b>adoções conluidas</b></h2></center><br>
                            </div>
                    ...
                    <table class="table table-striped table-hover"  style="margin-bottom: 40rem;">
                        ...
                        <tbody>
                            <?php
                            $registrosObtidos = unserialize($_SESSION['listaadocaousuarios']);

                            foreach ($registrosObtidos as $listaadotadosOBJ) {
                                ?> 

                             <tr>
                                    <td><?php echo $listaadotadosOBJ->getFk_id_adocao(); ?></td>
                                    <td><?php echo $listaadotadosOBJ->getFk_id_usuario(); ?></td>
                                    
                                    <td><?php echo $listaadotadosOBJ->getnomeusuario(); ?></td>
                                    <td><?php echo $listaadotadosOBJ->getendereco(); ?></td>
                                    <td><?php echo $listaadotadosOBJ->getemail(); ?></td>
                                    <td><?php echo $listaadotadosOBJ->getId_animais(); ?></td>
                                    ...
                                    <td> 
                                        ...
                                        <a href="../../../Controller/AnimaisController.php?acao=removeradocao&id=<?php echo $listaadotadosOBJ->getFk_id_adocao(); ?>&idanimal=<?php echo $listaadotadosOBJ->getId_animais(); ?>" class="delete" data-toggle='tooltip'>
